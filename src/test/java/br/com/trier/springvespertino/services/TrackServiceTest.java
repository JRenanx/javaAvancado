...
public class TrackServiceTest extends BaseTests {
    ...
    void listAllPistaTest() {
        List<Track> lista = pistaService.listAll();
    ...
    void insertPistaTest() {
        Track pista = new Track(4, "Pista da HotWhells", 6000, null);
    ...
    void updatePistaTest() {
        var pista = pistaService.findById(1);
        assertEquals("Pista", pista.getName());
        var pistaAltera = new Track(1, "Pista 500", 3000, null);
    ...
    void findBySizeBetweenTest() {
        List<Track> result = pistaService.findBySizeBetween(1000, 3000);
        List<Track> pistaList = new ArrayList<>();
        pistaList.add(new Track(1, "Pista", 1000, null));
        pistaList.add(new Track(2, "Indy", 2000, null));
        pistaList.add(new Track(3, "Rampa", 3000, null));
    ...
    void findBySizeBetweenInvalidFoundTest() {
        List<Track> pistaList = new ArrayList<>();
        pistaList.add(new Track(1, "Pista", 500, null));
        pistaList.add(new Track(2, "Indy", 200, null));
        pistaList.add(new Track(3, "Rampa", 800, null));
    ...
    void testInsertPistaInvalidSizeTest() {
        Track pista = new Track(null, "insert", -2000, null);
    ...
    void findPistaByPaisEmptyListTest() {
        var exception = assertThrows(ObjectNotFound.class, () -> pistaService.findByCountryOrderBySizeDesc(paisService.findById(100)));
    ...
    void findByPaisOrderBySizeTest() {
        List<Track> lista = pistaService.findByCountryOrderBySizeDesc(paisService.findById(1));
    ...
    void findByPaisOrderEmptyTest() {
        var exception = assertThrows(ObjectNotFound.class, () -> pistaService.findByCountryOrderBySizeDesc(paisService.findById(1)));
